...
START_TEST(task_s21_sin) {
    ...
    ck_assert_double_eq_tol(s21_sin(20), sin(20), 1e-6);
    ck_assert_double_eq_tol(s21_sin(-40), sin(-40), 1e-6);
}
END_TEST
...
START_TEST(task_s21_cos) {
    ...
    ck_assert_double_eq_tol(s21_cos(20), cos(20), 1e-6);
    ck_assert_double_eq_tol(s21_cos(-40), cos(-40), 1e-6);
}
END_TEST
